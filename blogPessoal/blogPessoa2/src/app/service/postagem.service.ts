...
export class PostagemService {
  ...
  token={
    headers:new HttpHeaders().set('Authorization',environment.token)//coloca o token nos headers
  }
  ...
  deletePostagem(id:number){
    return this.http.delete(`http://localhost:8080/post0agens/${id}`,this.token)
  }
